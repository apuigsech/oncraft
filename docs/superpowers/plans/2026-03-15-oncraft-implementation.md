...
oncraft/
  ...
  src/
    ...
    services/
      ...
      config-loader.ts              # .oncraft/config.yaml read/write/validate
...
Run:
```bash
pnpm create tauri-app oncraft-init --template vue-ts --manager pnpm
```
...
4. `.oncraft/config.yaml` is created in the project directory
