# OnCraft - Implementation Tasks

**Feature**: OnCraft - Claude Code Session Kanban Manager
**Generated from**: spec (2026-03-15-oncraft-design.md), plan (2026-03-15-oncraft-implementation.md)
**Date**: 2026-03-15
...
- [ ] T015 [P] Create settings Pinia store in `src/stores/settings.ts`: load/save ~/.oncraft/settings.yaml, updateClaudePath()
...
- [ ] T059 Final commit: "feat: OnCraft v0.1.0 - Claude Code session Kanban manager"
